...
private:
    ...
    double r_drop;             // rate drop out
    int t_drop;             // type drop, 0 is drop topic, 1 is drop word
...
public:
    ...
    OBTM(int K, int W, double a, double b, int n_iter, double l, double r_drop, int t_drop);
